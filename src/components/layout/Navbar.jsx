...
const Navbar = () => {
  ...
  {/* Logo */}
  <Link to="/" className="flex items-center space-x-2 ps-2">
    <img
  ...
  <div className="hidden md:flex items-center gap-8 text-sm text-[#45556C]">
    <Link to="/landing" className="hover:text-black transition-colors">Features</Link>
    <Link to="/landing" className="hover:text-black  transition-colors">Courses</Link>
    <Link to="/landing" className="hover:text-black  transition-colors">Testimonials</Link>
    <Link
      to="/login"

  ...
  return (
    <div className="space-10">
      {fields.map((item, index) => (
        <div
          key={item.id}
          className="grid grid-cols-1 lg:grid-cols-2 gap-8 border rounded-xl p-6"
        >
          {/* ===== Section Name ===== */}
          <div>
            <div className="flex justify-between mb-2 border border-b-gray-300 pb-2">
              <h4 className="font-medium text-[#093332] ">Edit Section Name</h4>
              <button
            ...
            <div className="flex gap-3 mt-6 justify-between">
              ...
              <button
                type="button"
                className="btn-primary  text-[#FFFFFF] bg-[#176D69] font-semibold px-4 py-2 cursor-pointer"
              >
                Save Changes
              </button>
            </div>
          ...
          <div>
            ...
            <div className="relative w-full">
              ...
              {/* fake input */}
              <div className="flex items-center  border border-[#176D69] text-[#176D69] overflow-hidden">
                ...
                <label
                  htmlFor={`video-${index}`}
                  className="px-4 py-3 bg-[#A6E5E35C] text-sm font-medium cursor-pointer text-[#093332]"
                >
                  Upload File
                </label>
              </div>
            ...
            <div className="flex gap-3 mt-4 justify-between">
              ...
              <button
                type="button"
                className="btn-primary bg-[#176D69] text-[#FFFFFF] font-semibold px-4 py-2 cursor-pointer"
              >
                Upload Video
              </button>
            </div>
          ...
          <div>
            ...
            <input
              ...
              className="input w-full border border-[#176D69] text-[#176D69] p-10"
      ...
      <div className="flex justify-between mb-2 border border-b-gray-300 pb-2">
              ...
              className="textarea w-full  border border-[#176D69] text-[#176D69]"
              rows={4}

...
export default function OrderSummary() {
  return (
    <div
      className=" bg-white rounded-xl p-6 border border-borderGray
        sticky top-10 w-full sm:max-w-md lg:w-[405px]
    ...
    >
      ...
      <div
        className=" space-y-1 mb-1 w-full lg:w-[405px] h-auto lg:h-[338px] "
      >
        <div
        ...
        <div
          className=" flex justify-between items-center w-full lg:w-[356px] h-[22px] "
        >
      ...
      <hr className="border-borderGray mb-4 w-full lg:w-[356px]" />

    
      <div
        className=" flex gap-2 mb-4 w-full lg:w-[356px] h-[36px]"
      >
      ...
      <button
        className="
          w-full lg:w-[356px]
          h-[48px]
          bg-prime hover:bg-[#15534f]
          text-white py-2 rounded-lg text-base
      ...
      <p
        className="text-center text-[#71717A] text-xs mt-3 leading-relaxed w-full lg:w-[356px]"
      >

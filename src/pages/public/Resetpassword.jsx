    ...
    const handleSubmit = async (e) => {
        ...
        if (validate()) {
            ...
            try {
                ...
                setPopup({ show: true, title: 'Error', message: 'Failed to reset password. Please try again.', type: 'error' });
            } finally {
                setIsLoading(false);
            }
        }
                ...
                <div className="px-8 pb-8">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none transition-colors duration-200 ${errors.confirmPassword ? 'text-red-400' : 'text-gray-400 group-focus-within:text-[#0F4C4A]'}`}>
                                    <Lock className="h-5 w-5" />
                                </div>
                                <input

...
const ForgetPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // navigate('/verify-code'); // Optional: redirect to verify code page
        } catch (err) {
            ...
            <div className="bg-white w-full max-w-[450px] rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-500 mx-auto">
                ...
                <div className="px-8 pb-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none transition-colors duration-200 ${error ? 'text-red-400' : 'text-gray-400 group-focus-within:text-[#0F4C4A]'}`}>
                    ...
                    <div className="mt-8 text-center">
                        <Link to="/login" className="inline-flex items-center text-gray-500 hover:text-[#0F4C4A] transition-colors text-sm font-medium gap-2">
